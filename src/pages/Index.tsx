...
const Index = () => {
  ...
  <CardContent className="space-y-4"> {/* Added space-y-4 for vertical gap */}
    ...
    <div className="pt-2">
      <Button
        ...
        className="w-full gap-2 h-11" // w-full makes it span the card width
      >
  ...
  <a 
    ...
    className="font-bold text-foreground hover:text-primary underline-offset-4 hover:underline transition-colors"
  >
    ExchangeRate-API
  </a>
  {' '}
